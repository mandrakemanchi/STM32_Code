...
***********************************************************
File    : HIF_UART.c
Purpose : Terminal control for Flasher using USART3 on PD8/PD9
--------- END-OF-HEADER ---------------------------------*/
...
#define USART3_BASE_ADDR    0x40020C00
...
#define GPIO_UART_TX_BIT    5              // USART3 TX: Pin pd8
#define GPIO_UART_RX_BIT    6             // USART3 RX: Pin pd9
